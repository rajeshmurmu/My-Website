...
export default function Footer() {
  return (
    <div>
      {/* <!-- ############################## Footer-container ##################################### --> */}
      <footer id="contact" className="w-full h-auto md:h-[755px] bg-[#001D38]">
        ...
        <div className="footer-links w-4/5 h-1/5 m-auto flex justify-between items-center py-10">
          <div className="footer-nav-links w-full h-full flex justify-center items-center md:block">
            <ul className="flex items-center gap-8 md:gap-12 text-white text-base md:text-lg">
              <li>
                <a href="#">About</a>
              </li>
              <li>
        ...
        <div className="footer-bottom w-full md:w-4/5 h-auto md:h-1/6 m-auto text-white border-t-2 border-gray-500 border-solid">
